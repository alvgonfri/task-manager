          ...
          {isAuthenticated ? (
            <>
              ...
              <div className="flex gap-x-4 mt-5">
                <Link
                  to="/tasks"
                  className="bg-slate-700 hover:bg-slate-800 text-slate-50 font-medium rounded-lg text-xl px-5 py-2.5"
                >
                  View tasks
                </Link>
                <Link
            ...
            <>
              ...
              <div className="flex gap-x-4 mt-5">
                ...
                <Link
                  to="/register"
                  className="bg-slate-400 hover:bg-slate-500 text-slate-50 font-medium rounded-lg text-xl px-5 py-2.5"
                >
                  Register
                </Link>
              </div>
